...
app.post("/", function (req, res) {
    ...
    let url =
      "https://api.openweathermap.org/data/2.5/weather?q=" +cityname +"&appid=2c178e5a3c0684cea8716919b91edc0d&units=metric";
    ...
    https.get(url, function (response) {
      ...
      response.on("data", function (data) {
        ...
        res.write(
          "<h1><center>Temperature in <b>" +
            city +
            "</b> is: <b>" +
            temp +
            "</b> degrees Celsius and is <b>" +
            feelslike +
            "</b></center></h1>"
        );
